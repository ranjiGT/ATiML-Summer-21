...
class DataLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(len(x_min)):
            ...
            #print(sub_img.shape)
            sub_img = resize(sub_img, (128,128))
...
with open('color_layout_descriptor.pkl','wb') as f:
    pickle.dump(color_layout_features, f)
    
with open('bow_surf.pkl','wb') as f:
...
# 
# 
# color_layout_array = np.array(color_layout_features)
# color_layout_array = scale(color_layout_array, 0, 1)
# 
# 
# 
# color_hist_array = np.array(color_hist_features)
# color_hist_array = scale(color_hist_array, 0, 1)
# 
# 
# features = np.hstack([color_layout_array, np.array(bow_surf), color_hist_array])
# features.shape
# =============================================================================
# =============================================================================
